...
### TOML File for production

1. Create a file **shopify.app.prod.toml** for the production environment.
2. Run the command **npm run config:use prod** to configure the production TOML file.
3. Run the command **npm run deploy** to deploy the new change to production shopify application.
